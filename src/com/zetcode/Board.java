...
private void loadImages() {
    ...
    head = new ImageIcon(getClass().getResource("/resources/head.png")).getImage();
        ...
        System.out.println("Head : " + head.getWidth(this));
        System.out.println("Ball : " + ball.getWidth(this));
        System.out.println("Apple: " + apple.getWidth(this));
    }
    ...
    private void gameOver(Graphics g) {
        ...
        g.drawString(msg,
                (B_WIDTH - metrics.stringWidth(msg)) / 2,
                B_HEIGHT / 2);
    }
